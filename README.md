...
A token can be required by a server to access data. Most often there is a JWT, or JSON Web Token that is used to authenticate a user. Providing it to the server will prove that the user is signed in and return data, or route to a private location on your site.

- [ ] What steps can you take in your web apps to keep your data secure?

Creating private routes that can only be accessed by signed in users is one level of security. Requiring the aforementioned JWT is another way of protecting your site.

- [ ] Describe how web servers work.

The physical computer device that we call a server is connected to the internet, and stores the code for different websites to be shared across the world at all times. The software behind a web server's sole purpose is to 'serve' web pages it retrieves from your project code to users who requested it.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

CRUD stands for Create, Read, Update, Delete. Each is responsible for creating a dynamic website.
